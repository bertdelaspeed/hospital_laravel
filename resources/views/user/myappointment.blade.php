                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @if (Route::has('login'))
                            @auth
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" style="background-color:darkolivegreen; color:white"
                                        href="{{ url('myappointment') }}">My Appointments</a>
                                </li>
                                <x-app-layout>
            ...
            @foreach ($appoint as $appoints)
                <tr style="background-color:black" align='center'>
                    ...
                    <td><a onclick="return confirm('Are you sure you want to delete ?')"
                            href="{{ url('cancel_appointment', $appoints->id) }}" class="btn btn-danger">Cancel</a>
                    </td>
                </tr>
            @endforeach
        </table>
